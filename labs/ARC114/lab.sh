...
print_welcome() {
    ...
    echo "${BLUE_TEXT}${BOLD_TEXT}  Google Cloud NLP API Demonstration  - ePlus.DEV        ${RESET_FORMAT}"
    echo "${BLUE_TEXT}${BOLD_TEXT}=============================================${RESET_FORMAT}"
    echo
}
...
print_completion() {
    ...
    echo "${GREEN_TEXT}${BOLD_TEXT}      Lab Completed Successfully! - ePlus.DEV           ${RESET_FORMAT}"
    echo "${GREEN_TEXT}${BOLD_TEXT}=============================================${RESET_FORMAT}"
    echo
    echo
}
