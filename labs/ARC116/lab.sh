...
echo "${ORANGE_TEXT}${BOLD_TEXT}                ePlus.DEV ${RESET_FORMAT}"
echo "${ORANGE_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
...
echo -e "\n${ORANGE_TEXT}Creating MIG A...${RESET_FORMAT}"
...
echo -e "${ORANGE_TEXT}Creating Firewall Rule...${RESET_FORMAT}"
...
echo -e "${ORANGE_TEXT}Creating Health Check...${RESET_FORMAT}"
gcloud compute health-checks create http http-check-alb \
    --global \
    --port=80

echo -e "${ORANGE_TEXT}Creating Backend Service...${RESET_FORMAT}"
...
echo -e "${ORANGE_TEXT}Adding Backends...${RESET_FORMAT}"
...
echo -e "${ORANGE_TEXT}Generating SSL Certificate...${RESET_FORMAT}"
