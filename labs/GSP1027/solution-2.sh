...
echo "${CYAN_TEXT}${BOLD_TEXT}============================${RESET_FORMAT}"
echo
echo "${GREEN_TEXT}${BOLD_TEXT}Don't forget to subscribe to David Nguyen YouTube channel:${RESET_FORMAT}"
...
echo "${CYAN_TEXT}${BOLD_TEXT}============================================${RESET_FORMAT}"
echo
echo "${GREEN_TEXT}${BOLD_TEXT}Thank you for following David Nguyen Cloud Tutorial!${RESET_FORMAT}"
