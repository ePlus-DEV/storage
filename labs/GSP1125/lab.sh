...
gcloud dns --project=$DEVSHELL_PROJECT_ID policies create dns-test-policy --description="cloudwalabanda" --networks="default" --private-alternative-name-servers="" --no-enable-inbound-forwarding --enable-logging
