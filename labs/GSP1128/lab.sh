...
echo "==============================================="
echo " Welcome to ePlus.DEV Tutorial 🚀"
...
gcloud kms keys create mpc-key \
  --location=global \
  --keyring=mpc-keys \
  --purpose=encryption \
...
echo " Thank you for using ePlus.DEV Tutorial"
echo " Subscribe for more Cloud & DevOps Labs 🚀"
echo "==============================================="