...
echo
echo "${BOLD_TEXT}${RED_TEXT}Please create the export configuration:${RESET_FORMAT}"
echo "${BOLD_TEXT}${GREEN_TEXT}https://console.cloud.google.com/security/command-center/config/continuous-exports/pubsub?project=${PROJECT_ID}${RESET_FORMAT}"
echo
...
echo
echo "${GREEN_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}https://eplus.dev${RESET_FORMAT}"
echo

echo "Next steps:"
echo "${BOLD_TEXT}┣ View findings in BigQuery: ${GREEN_TEXT}https://console.cloud.google.com/bigquery?project=${PROJECT_ID}${RESET_FORMAT}"