...
# ========================= AUTH CHECK =========================
echo "${ORANGE_TEXT}${BOLD_TEXT}Checking active gcloud authentication...${RESET_FORMAT}"
gcloud auth list

# ========================= SET ZONE & REGION =========================
echo "${ORANGE_TEXT}${BOLD_TEXT}Fetching default compute zone and region...${RESET_FORMAT}"
...
gcloud logging sinks create drabhishek_sink \
