...
function random_subscribe_message() {
    MESSAGES=(
        "${BOLD}${RED}Please ${GREEN}Subscribe ${YELLOW}to ${BLUE}Dr ${MAGENTA}Abhishek ${CYAN}Cloud Tutorial!${RESET}"
        "${BOLD}${CYAN}Don't miss out! Subscribe to ${MAGENTA}Dr ${GREEN}Abhishek ${BLUE}Cloud Tutorial!${RESET}"
        "${BOLD}${RED}Hit that subscribe button for more amazing content from ${CYAN}Dr ${GREEN}Abhishek ${MAGENTA}Cloud Tutorial!${RESET}"
        "${BOLD}${YELLOW}Join the ${GREEN}Dr ${CYAN}Abhishek ${MAGENTA}Cloud Tutorial community! Subscribe now!${RESET}"
        "${BOLD}${BLUE}Want more tutorials? ${MAGENTA}SUBSCRIBE ${YELLOW}to ${CYAN}Dr ${GREEN}Abhishek ${BLUE}Cloud Tutorial!${RESET}"
        "${BOLD}${RED}Your subscription helps us bring more tutorials to you! Please ${CYAN}subscribe to ${MAGENTA}Dr ${GREEN}Abhishek ${BLUE}Cloud Tutorial!${RESET}"
        "${BOLD}${YELLOW}Subscribe to ${CYAN}Dr ${MAGENTA}Abhishek ${GREEN}Cloud Tutorial to stay updated on all our tutorials!${RESET}"
        "${BOLD}${CYAN}Keep learning with us! ${GREEN}Subscribe to ${MAGENTA}Dr ${YELLOW}Abhishek ${RED}Cloud Tutorial!${RESET}"
        "${BOLD}${MAGENTA}Support us and get access to exclusive tutorials by subscribing to ${CYAN}Dr ${GREEN}Abhishek ${BLUE}Cloud Tutorial!${RESET}"
        "${BOLD}${BLUE}Love the content? Subscribe to ${MAGENTA}Dr ${CYAN}Abhishek ${GREEN}Cloud Tutorial!${RESET}"
        "${BOLD}${RED}Help us grow by subscribing to ${CYAN}Dr ${MAGENTA}Abhishek ${YELLOW}Cloud Tutorial! Your support is crucial!${RESET}"
        "${BOLD}${GREEN}Don't forget to hit subscribe to stay up to date with ${CYAN}Dr ${MAGENTA}Abhishek ${BLUE}Cloud Tutorial!${RESET}"
        "${BOLD}${YELLOW}Want to join the ${BLUE}Dr ${MAGENTA}Abhishek ${CYAN}Cloud Tutorial family? Hit subscribe!${RESET}"
        "${BOLD}${MAGENTA}We appreciate your support! Please ${CYAN}subscribe to ${GREEN}Dr ${RED}Abhishek ${BLUE}Cloud Tutorial!${RESET}"
        "${BOLD}${CYAN}Your subscription makes a difference! Help us grow by subscribing to ${MAGENTA}Dr ${YELLOW}Abhishek ${GREEN}Cloud Tutorial!${RESET}"
        "${BOLD}${RED}Every click counts! Please subscribe to ${BLUE}Dr ${MAGENTA}Abhishek ${CYAN}Cloud Tutorial!${RESET}"
    )
    RANDOM_INDEX=$((RANDOM % ${#MESSAGES[@]}))
    echo -e "${BOLD}${MESSAGES[$RANDOM_INDEX]}"
}
