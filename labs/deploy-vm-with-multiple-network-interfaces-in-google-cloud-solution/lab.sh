...
echo -e "${WHITE}${BOLD}Create Multi-NIC VM${RESET}"
echo -e "${MAGENTA}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
echo
...
if gcloud compute instances create "$VM_NAME" \
  ...
  --network-interface=network="$NETWORK2",subnet="$SUBNET2"; then

  echo -e "${GREEN}${BOLD}✔ VM '${VM_NAME}' created successfully.${RESET}"
else
  echo -e "${RED}${BOLD}✖ Failed to create VM '${VM_NAME}'.${RESET}"
  exit 1
fi
...
echo -e "${CYAN}${BOLD}✔ NICs         : ${NETWORK1}/${SUBNET1} , ${NETWORK2}/${SUBNET2}${RESET}"
echo -e "${MAGENTA}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
